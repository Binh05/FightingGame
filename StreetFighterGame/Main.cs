...
namespace StreetFighterGame
{
    public partial class StreetFighterGame : Form
    {
        ...
        private void OnPaint(object sender, PaintEventArgs e)
        {
            ...
            if (logicGame.Player1.DangDanhDungKo() && !logicGame.Player1.isDashing) DrawHitbox(e, attackType: ActionState.AttackingI, logicGame.Player1, flip: false, logicGame.Player2);
            if (logicGame.Player2.DangDanhDungKo() && !logicGame.Player2.isDashing)  DrawHitbox(e, attackType: ActionState.AttackingI, logicGame.Player2, flip: false, logicGame.Player1);
